  ...
  _createClass(ArrayField, [{
    ...
    value: function renderArrayFieldItem(props) {
      var index = props.index,
          ...
          olriginalItemUiSchema = props.itemUiSchema,
      ...
      var itemUiSchema = (0, _lodash4.default)(olriginalItemUiSchema);
      if (uiSchema.itemsInstances && uiSchema.itemsInstances[index]) {
        (0, _lodash2.default)(itemUiSchema, uiSchema.itemsInstances[index]);
      }
